...
🇧🇷 Português
Para este projeto, explorei dados do Censo da Educação Superior, realizado pelo Instituto Nacional de Estudos e Pesquisas Educacionais Anísio Teixeira (Inep) entre 2016 e 2024. A partir de uma amostra nacional de cerca de 10 milhões de matrículas, fiz um recorte para compreender o cenário da capital federal, considerando homens, mulheres, pessoas autodeclaradas PPI e não PPI.
...
🔗 Fonte: gov.br/inep
🛠️ Ferramentas: Excel e Power BI

🎓 Higher Education Flow Indicators in the Federal District of Brazil
🇺🇸 English
As a public administrator, I couldn't leave relevant topics from the Brazilian reality out of my data analysis projects. For this project, I explored data from the Higher Education Census conducted by Brazil's National Institute for Educational Studies and Research (Inep) between 2016 and 2024. Drawing from a national sample of approximately 10 million enrollments, I focused on the Federal District, analyzing indicators across gender and ethnic-racial groups — specifically PPI (Black, Brown, and Indigenous students) and non-PPI.
Key Indicators
...
### Principais indicadores
- Total de respondentes: 481
- Usuários de redes sociais: 99,4%
- Heavy users: 57,38%
- Análises por gênero, faixa etária, ocupação e plataformas mais utilizadas
- Respostas em escala Likert sobre bem-estar emocional
...
This project was developed as an independent initiative to apply data analysis knowledge in practice, integrating UX Design principles focused on data visualization and information interpretation.

The goal was to explore the relationship between social media usage and mental health indicators, using the **"Social Media and Mental Health"** dataset from Kaggle, comprising 481 respondents.

The entire process was conducted independently, without tutorials or ready-made templates — from dataset selection and understanding, through data cleaning and organization, KPI definition, and dashboard development, to visual refinement focused on clarity and reading experience.

#### Key Metrics
- Total respondents: 481
- Social media users: 99.4%
- Heavy users: 57.38%
- Breakdown by gender, age group, occupation, and most-used platforms
- Likert scale responses on emotional well-being
